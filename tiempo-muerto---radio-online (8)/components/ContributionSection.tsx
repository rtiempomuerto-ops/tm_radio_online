...
const ContributionSection: React.FC<ContributionProps> = ({ customTitle }) => {
  ...
  const MONTHLY_LINKS: Record<string, { label: string, amount: number, icon: any, link: string }> = {
    socio_mate: { 
      label: 'SOCIO MATE', 
      amount: 1500, 
      icon: <MateIcon className="w-8 h-8 text-emerald-600" />, 
      link: REAL_MATE_LINK 
    },
    socio_plata: { 
      label: 'SOCIO PLATA', 
      amount: 4500, 
      icon: <i className="fas fa-medal text-slate-400 text-2xl"></i>, 
      link: 'https://www.mercadopago.com.ar/subscriptions/checkout?preapproval_plan_id=2c9380848f3e5c7a018f4357c3e5033c' 
    },
    socio_oro: { 
      label: 'SOCIO ORO', 
      amount: 15000, 
      icon: <i className="fas fa-crown text-yellow-500 text-2xl"></i>, 
      link: 'https://www.mercadopago.com.ar/subscriptions/checkout?preapproval_plan_id=2c9380848f3e5c7a018f4358a9b2033d' 
    },
    socio_platino: { 
      label: 'SOCIO PLATINO', 
      amount: 30000, 
      icon: <i className="fas fa-gem text-blue-500 text-2xl"></i>, 
      link: 'https://www.mercadopago.com.ar/subscriptions/checkout?preapproval_plan_id=2c9380848f3e5c7a018f43594f0e033e' 
    }
  };
